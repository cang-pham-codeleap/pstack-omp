...
- `Read` tool calls against any `SKILL.md` file (workspace `<cwd>/.omp/skills/`, user-level `~/.omp/agent/skills/` and `~/.omp/agent/managed-skills/`, or installed plugin trees under `~/.omp/plugins/`)
