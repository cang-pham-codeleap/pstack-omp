...
- "the code-review bot flagged regex backtracking on May 2"
...
| <new pattern, no existing skill is a real home> | <draft a new skill via manage_skill> | <new skill via manage_skill: <kebab-name>> |
