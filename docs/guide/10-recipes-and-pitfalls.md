...
![She tastes a finished dish while robots cook from a recipe box, with pinned cards reading /how, /tdd, and /swarm above the counter.](./images/recipes.jpg)
...
```text
/skill:poteto-mode repro the duplicate write first. if there's a cheap test path, /skill:tdd it. then fix and rerun.
```
...
That's the whole prompt. [`/skill:bro`](../../skills/bro/SKILL.md) restates the last message like one human talking to another, no jargon, shorter. Use it when a reply is technically thorough and you still don't know what it said.
